...
<form method="post" action="?m=titik_ubah&ID=P01">
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode" readonly="readonly" value="P01"/>
            </div>
            <div class="form-group">
                <label>Nama Titik <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama" value="Pura Agung Besakih" id="nama"/>
            </div>
            <div class="form-group">
                <label>Latitude <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="lat" id="lat" value="-8.374387" readonly=""/>
            </div>
            <div class="form-group">
                <label>Longitude <span class="text-danger">*</span></label>
                <input class="form-control" type="text" id="lng" name="lng" value="115.45094740000002" readonly=""/>
            </div>
            <div class="form-group">
